...
A distributed data flow and computation system that runs on transactional messaging infrastructure. It is designed to operate as a NVM Networked-Virtual-Machine by implementing distributed logic over hardware CPU/GPU processors.
